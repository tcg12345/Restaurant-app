...
import RatingAdjustmentPage from "./pages/RatingAdjustmentPage";
          ...
          <DiscoverProvider>
            <FriendProfilesProvider>
              <CommunityDataProvider>
                ...
                <Sonner />
                <Routes>
                {/* Auth routes - don't need RestaurantProvider */}
                ...
                <Route path="/rating-adjustment" element={<RequireAuth><Layout showNavbar={false} showChatbot={false}><RatingAdjustmentPage /></Layout></RequireAuth>} />
