...
export function RestaurantListsView({ onSelectList }: RestaurantListsViewProps) {
  ...
  const [listToDelete, setListToDelete] = useState<RestaurantList | null>(null);
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          >
            ...
            {isDeleteMode ? 'Done Deleting' : 'Delete Lists'}
          </Button>
          {!isDeleteMode && (
          ...
          {filteredLists.map(list => (
            <div key={list.id} className="relative group">
              <RestaurantListCard
                ...
                onDelete={list.is_default ? undefined : handleDeleteClick}
      ...
      <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction 
              onClick={handleFirstConfirmDelete}
      ...
      <AlertDialog open={showFinalDeleteDialog} onOpenChange={setShowFinalDeleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This is your final warning. Deleting "{listToDelete?.name}" will permanently remove:
              <br /><br />
              • The list and all its restaurant entries
              • Any custom organization you've created
